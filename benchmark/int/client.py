...
if nntype == ISOLET:
    ...
    true_results = [5, 8, 0, 18, 11, 7, 16, 4, 14, 18, 14, 3, 8, 4, 18, 3, 6, 10, 4, 17, 3, 0, 2, 16, 4, 8, 13, 16, 0, 16, 10, 0, 3, 16, 13, 8, 3, 9, 2, 14, 3, 10, 5, 0, 5, 12, 11, 15, 4, 18, 13, 16, 10, 11, 14, 12, 1, 13, 5, 17, 3, 6, 12, 3, 5, 8, 3, 10, 6, 5, 4, 9, 8, 16, 9, 6, 18, 15, 3, 9, 18, 5, 17, 15, 15, 10, 16, 15, 11, 8, 15, 17, 9, 4, 14, 10, 4, 4, 8, 16]
probabilities = []
